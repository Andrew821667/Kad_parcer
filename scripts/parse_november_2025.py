...
Рабочих дней: 20 (пропускаем выходные и праздники)
Запросов: 20 дней × ~100 судов = ~2000 запросов
Ожидаемый результат: ~25,000 дел
"""
...
async def main():
    ...
    print("   Рабочих дней: 20")
    print("   Цель: ~25,000 дел")
    print("=" * 80)
    print()
